...
class Domain(collections.MutableMapping):
    """
    Domain is a mutable dict of variables that are made available
    ...
    def __enter__(self):
        ...
        self.__dict__['_parent'] = Domain.root
        Domain.root = self
